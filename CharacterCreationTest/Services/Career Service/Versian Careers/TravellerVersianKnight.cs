    ...
    class TravellerVersianKnight : TravellerVersianCareers
    {
       ...
       assignments: new List<TravellerAssignment>
       {
                    new TravellerAssignment(
                        ...
                        {
                            ("Page", new TravellerRewardtem(new TravellerWeapon("Void Blade",5000000,1,20,0,"12D12",0,"Void"))),
                            ("Squire", new TravellerRewardSkill(Melee_Void)),
                            ("Knight", new TravellerRewardtem(new TravellerArmour("Ordinis Armour",5000000,100,18,
       ...
       }, musteringOutBenefits: new List<(int Cash, TravellerCharacterCreationReward Benefit)>
       {
                    ...
                    (500000, new TravellerRewardtem(new TravellerWeapon("Knights Revolver",10000,2,18,0,"8D8",10,"Plasma Based"))),
