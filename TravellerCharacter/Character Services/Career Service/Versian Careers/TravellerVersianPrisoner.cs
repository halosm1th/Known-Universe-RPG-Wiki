...
{
    class TravellerVersianPrisoner : TravellerVersianCareers
    {
        public static TravellerCareer VersianPrisoner()
        {
            return new TravellerCareer(
                ...
                qualifications: new List<TravellerAttributeCheck>
                {
                    ...
                    new TravellerAttributeCheck(TravellerAttributes.Dexterity,2),
                    new TravellerAttributeCheck(TravellerAttributes.Endurance,2),
                },
                assignments: new List<TravellerAssignment>
                {
                    new TravellerAssignment(
                        ...
                        survival: new TravellerAttributeCheck(TravellerAttributes.Dexterity,6),
                        advancement: new TravellerAttributeCheck(TravellerAttributes.Education,10),
                    ...
                    new TravellerAssignment(
                        ...
                        survival: new TravellerAttributeCheck(TravellerAttributes.Strength,6),
                        advancement: new TravellerAttributeCheck(TravellerAttributes.Intelligence,10),
                        skillList: new List<TravellerSkillTableEntry>
                        {
                    ...
                    new TravellerAssignment(
                        ...
                        survival: new TravellerAttributeCheck(TravellerAttributes.Social,8),
                        advancement: new TravellerAttributeCheck(TravellerAttributes.Social,10),
                        skillList: new List<TravellerSkillTableEntry>
                        {
                ...
                musteringOutBenefits: new List<(int Cash, TravellerCharacterCreationReward Benefit)>
                {
                    ...
                    (100, new TravellerRewardSkillChoice(1,new List<TravellerSkills>{TravellerSkills.Stealth,TravellerSkills.Leadership})),
                ...
                events: new List<TravellerEventCharacterCreation>
                {
                    ...
                    new TravellerEventSkillCheck("You are accused of stealing while on work detail. Make a check to avoid getting locked in solitary confinement.",
                        ...
                        {
                            new TravellerSkillCheck(TravellerSkills.Deception,8),
                            new TravellerSkillCheck(TravellerSkills.Persuade,8)
                        }),
                    new TravellerEventAttributeCheck("The Knight who owns your prison has returned from a bender which has resulted in a shortfall of cash. To solve this issue, your prison has been sold to another knight. Your new keeper has come for an inspection, giving you a possible chance to show off.",
                        ...
                        successEvent: new TravellerEventReward("Because you impressed your new master you gain an extra benefit.",
                    ...
                    new TravellerEventChoice("You are transfered to another prison, during the transfer, the ship is attacked and you are given a chance to join the pirates, do you?",
                        ...
                        yesEvent:new TravellerEventSkillCheck("Stepping into the fray, you are tossed a melee weapon and told to help.",
                            ...
                            new List<TravellerSkillCheck>
                            {
                                new TravellerSkillCheck(TravellerSkills.Melee,8)
                            }),
                        noText:"No",
