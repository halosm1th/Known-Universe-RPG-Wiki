...
{
    internal class TravellerVersianArmy : TravellerVersianCareers
    {
        ...
        public TravellerCareer GetVersianArmy()
        {
            return new TravellerCareer(
                "Versian Army",
                "You fight in an army, either for your lord or one of their knights. ",
                ...
                new List<TravellerAssignment>
                {
                    new(
                        "Footman",
                        "The sad people who have to open the door, check the rooms, and get shot. Someone has to be the grunts, and that's these guys.",
                    ...
                    new(
                        "Strongman",
                        "exo-Skeletons or light mech suits allow the Strongmen to carry powerful heavy weapons with ease, and act as heavy support troopers at the upper ranks.",
                    ...
                    new(
                        "Supplyman",
                        "Supplymen, as the name suggests, bring the supplies to the front line. They also drive the tanks and transports for the Army, and provide other forms of mechanized support.",
                ...
                events: new List<TravellerEventCharacterCreation>
                {
                    ...
                    new TravellerEventSkillCheck(
                        "You are part of a large scale siege which goes poorly. Trapped on the ground without support, make a check to survive.",
                        new TravellerEventReward("You sneak into the starport and get off the planet",
                        ...
                        new TravellerEventChangeCareers(
                            "You failed to get into the starport, you are captured and taken prisoner.",
                            "Versian Prisoner"),
                        new List<TravellerSkillCheck>
                        {
                            new(Stealth, 8),
                            new(Deception, 8),
                            new(GunCombat_Slug, 8)
                        }),

                    new TravellerEventSkillCheck("You are tasked to join in a black ops mission. Make a Stealth Check",
                        new TravellerEventReward("You are stealthy, the mission goes as planned.",
                            new List<TravellerCharacterCreationReward>
                            {
                        ...
                        new TravellerEventReward(
                            "You fail to be stealthy and everyone but one other is killed, the sole survivor blames you.",
                            new List<TravellerCharacterCreationReward>
                            {
                    ...
                    new TravellerEventSkillCheck(
                        "The planet you are currently on has come under siege and you are called to assist in its defense.",
                        new TravellerEventReward("You are instrumental in pushing the enemies back!",
                            new List<TravellerCharacterCreationReward>
                            {
                        ...
                        new TravellerEventText(
                            "The battle is lost, and after surendering you are transfered to a new lord."),
                        new List<TravellerSkillCheck>
                        {
                    ...
                    new TravellerEventChoice(
                        "You discover some of your squad mates are gambling and you are invited to join",
                        yesText: "You join the gambling!",
                        yesEvent: new TravellerEventSkillCheck("Joining in the gambling, you take your turn",
                            new TravellerEventReward("You make some winnings gambling!",
                                new List<TravellerCharacterCreationReward>
                                {
                                    new TravellerRewardBonusBenefit(random.Next(1, 7)),
                                    new TravellerRewardSkill(Gambler)
                                }),
                            new TravellerEventReward("You fail to make any winnings gambling.",
                                new List<TravellerCharacterCreationReward>
                                {
                                    new TravellerRewardBonusBenefit(random.Next(1, 4))
                                }),
                            new List<TravellerSkillCheck> { new(Gambler, 8) }),
                        noText: "I won't gamble",
                        noEvent: new TravellerEventText(
                            "You don't gamble this turn, keeping your benefits for yourself.")),
                    ...
                    new TravellerEventSkillCheck("While on patrol, you come under fire from an unknown area.",
                        new TravellerEventSkillChoiceReward("You hold your ground against the ambush",
                            new List<TravellerSkills>
                            {
                                GunCombat_Slug, Gunner
                            }),
                        new TravellerEventInjury("You are caught and wounded in the crossjob!"),
                        new List<TravellerSkillCheck>
                        {
                            new(Gunner, 8),
                            new(GunCombat_Slug, 8)
                    ...
                    new TravellerEventAttributeCheck("One of your supperior officers takes an interest in your career",
                        ...
                        failEvent: new TravellerEventReward(
                            "You spend the term doing extra work, which pays off in other ways",
                            new List<TravellerCharacterCreationReward>
                            {
                                new TravellerRewardBonusBenefit()
                            }),
                    ...
                    new TravellerEventSkillCheck(
                        "You join your Knight in their siege of another world, you join in the battle.",
                        new TravellerEventReward("You are able to shine in battle, impressing your knight.",
                            new List<TravellerCharacterCreationReward>
                            {
                                new TravellerRewardSkillChoice(1, new List<TravellerSkills>
                                {
                        ...
                        new TravellerEventText("You do nothing of note during the battle."),
                        new List<TravellerSkillCheck>
                        {
                            new(GunCombat_Slug, 8),
                            new(Gunner, 8)
                    ...
                    new TravellerEventChoice(
                        "You discover some of your fellow soldiers have been taking their vehicles out for ‘joyrides’ during their downtime, and invite you along.",
                        ...
                        noEvent: new TravellerEventReward(
                            "You decline to join them, reporting them to your superior earning you their anger.",
                            new List<TravellerCharacterCreationReward>
                            {
                    ...
                    new TravellerEventReward(
                        "There is no war this term, instead you spend it simply waiting at the starport.",
                        new List<TravellerCharacterCreationReward>
                        {
                            new TravellerRewardSkillChoice(1, new List<TravellerSkills>
                            {
                ...
                mishaps: new List<TravellerEventCharacterCreation>
                {
                    ...
                    new TravellerEventReward(
                        "You are publicly dishonoured, and for your failure you lose your title as a member of the militorius, demoted back to the Civis",
                        new List<TravellerCharacterCreationReward>
                        {
                            new TravellerRewardBonusBenefit(-1)
                        }),
                    new TravellerEventSkillCheck(
                        "Your Knight embarks on a suicide mission to impress someone further up the chain, and takes his army with him.",
                        new TravellerEventReward(
                            "you are able to survive the bloody slaughter,  but you are relieved from your service in your knights army.",
                            new List<TravellerCharacterCreationReward>
                            {
                                new TravellerRewardBonusBenefit()
                            }),
                        new TravellerEventInjury("You are wounded in combat"), new List<TravellerSkillCheck>
                        {
                            new(GunCombat, 8)
                        }),
                    new TravellerEventChangeCareers(
                        "You Encounter a psychopath in the army, and during battle they ask you to help them with an ambush. After success in the ambush, you go to investigate the corpses of your newly fallen foes, and discover to your horror that they are Versians as well. You are blamed for the issue. Change careers to Versian Prisoner for your crimes.",
                        "Versian Prisoner"),
                    new TravellerEventText(
                        "You are chosen for a black ops mission, the job goes south and everyone else is killed. You are left abandoned on a hostile world with no support."),
