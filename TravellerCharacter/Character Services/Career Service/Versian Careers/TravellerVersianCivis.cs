...
{
    internal class TravellerVersianCivis : TravellerVersianCareers
    {
        ...
        public TravellerCareer GetNationCareer()
        {
            return new TravellerCareer(
                ...
                new List<TravellerAssignment>
                {
                    new(
                        "Officer Worker",
                        "You work in an office, your days are long, but your work keeps the whole system flowing, even if you don’t fully understand exactly what it is that you actually do.",
                    ...
                    new(
                        "Business Starter",
                        "You are the starter of small businesses. You create value where none has been found yet. You socialize with people to gather funds and are able to work out the right kinds of deals for your goods.",
                    ...
                    new(
                        "Ship Owner",
                        "You own a ship. You are the backbone of the Universal economy. You pickup supplies from one planet and drop it off at another, hopefully securing a bit of a profit along the way.",
                ...
                events: new List<TravellerEventCharacterCreation>
                {
                    ...
                    new TravellerEventSkillCheck("You are framed for a crime you (might not have) committed",
                        new TravellerEventReward("You are able to negotiate your way into just paying a fine.",
                            new TravellerRewardDebt(100000)),
                        new TravellerEventChangeCareers("You are sent to prison", "Versian Prisoner"),
                        new TravellerSkillCheck(Advocate, 8)),

                    new TravellerEventReward(
                        "Your planet is swept by a wave of patriotism after a visit from your lord during a particularly good year. The high lasts for the term",
                        new TravellerRewardBenefitIncrease(1)),

                    new TravellerEventAttributeCheck(
                        "You spend the term pursuing your other hobbies as nothing of note happens.",
                        new TravellerEventReward("You peruse your hobbies, improving in the area you're looking at.",
                            new TravellerRewardSkillAny()),
                        new TravellerEventText(
                            "You spend the term 'improving your hobbies' by drinking and hanging out with your friends."),
                        (Education, 6)),

                    new TravellerEventAttributeCheck("Plague sweeps your planet, brought in from a trade ship.",
                        new TravellerEventReward(
                            "You weather the storm unharmed, and spend the time learning a new skill",
                            new TravellerRewardSkillAny()),
                        new TravellerEventInjury("The plague takes a toll on you."),
                        (Endurance, 6)),

                    new TravellerEventLife("You have a life event!"),

                    new TravellerEventAttributeCheck(
                        "The local knight has for some reason invited you to their court, to join in a party.",
                        new TravellerEventRewardAttribute(
                            "You are the talk of the party, everyone seems impressed by you.",
                            new TravellerAttribute(Social, 2)),
                        new TravellerEventRewardAttribute(
                            "You are whispered about the whole party, by the end of it you can tell several nasty rumours will be spread about you.",
                            new TravellerAttribute(Social, -2)),
                        (Social, 8)),

                    new TravellerEventSkillCheck(
                        "The politics on your planet this term become very vitriolic, and you can’t seem to avoid discussion about the topic.",
                        new TravellerEventRewardContact("You are able to skate by, keeping your friends.",
                            new List<TravellerRewardContact>
                            {
                                new("Political Friend 1", TravellerNPCRelationship.Contact),
                                new("Political Friend 2", TravellerNPCRelationship.Contact)
                            }),
                        new TravellerEventRewardContact("You are able to piss everyone off, angering your friends.",
                            new List<TravellerRewardContact>
                            {
                                new("Political Friend 1", TravellerNPCRelationship.Enemy),
                                new("Political Friend 2", TravellerNPCRelationship.Enemy)
                            }),
                        (Deception, 6)),

                    new TravellerEventChoice(
                        "The latest vnet show recently finished with an underwhelming conclusion that has left  fans seriously angered. Do you write to the writers?",
                        yesText: "Of course I let them know how wrong they are!",
                        yesEvent: new TravellerEventSkillCheck(
                            "You pen a letter, and with it a draft of how you would have ended the show",
                            new TravellerEventChangeCareerWithAssignment(
                                "The producer reads your letter and agrees with it. They invite you to write your own script, which gets greenlit and turned into a series. It's a smash hit and you’re promoted into the network",
                                "Versian Free Man", "Writer"),
                            new TravellerEventRewardAttribute(
                                "The writer returns a quick witted and harsh reply. You feel like a failure and put down a level.",
                                Education, -1),
                            (Diplomat, 8)),
                        noText: "Naw, I'll just vent on the message boards for a few days.",
                        noEvent: new TravellerEventText(
                            "You end up quickly finding a new hit series and falling in love with it, as the previous series quickly falls out of discussion.")),

                    new TravellerEventAttributeCheck(
                        "Your planet experiences a dip in trade, hurting the local economy, and you have to prove yourself at work.",
                        new TravellerEventReward(
                            "You easily show your worth to the company, and rewarded for it when the economy picks up again",
                            new TravellerRewardBonusBenefit()),
                        new TravellerEventReward("You are unable to show your value, and are unforunately let go.",
                            new TravellerRewardBonusBenefit(-1)),
                        (Education, 6)),

                    new TravellerEventAttributeCheck(
                        "War breaks out on your planet, while you are not directly involved in the fighting, your industry is still impacted by this.",
                        new TravellerEventReward(
                            "The war doesn't impacts your industry, and your job is spared. The war ends up being a born for your industry, earning you some extra cash.",
                            new TravellerRewardBonusBenefit(3)),
                        new TravellerEventReward("The war destroys your industry, your job, and your savings with it. ",
                ...
                mishaps: new List<TravellerEventCharacterCreation>
                {
                    ...
                    new TravellerEventChangeCareers(
                        "War breaks out on your planet and your Knight drafts you into the army", "Versian Army"),
                    new TravellerEventText(
                        "Through a series of events that are of no fault of your own, your company fails and you lose your job."),
                    new TravellerEventSkillCheck("You are (falsely) accused of a heinous crime.",
                        new TravellerEventText(
                            "After finishing character creation you start with A 2D6 million credit bounty on your head."),
                        new TravellerEventChangeCareers("You are taken to prison for your crimes!", "Versian Prisoner"),
                        new TravellerSkillCheck(Stealth, 8)),
                    new TravellerEventText(
                        "You’re made the scapegoat for a simple mistake, the coverup of which was a larger scandal then the mistake itself. As a result you are unable to work in that field anymore."),
