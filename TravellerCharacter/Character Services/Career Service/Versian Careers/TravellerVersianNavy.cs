...
{
    internal class TravellerVersianNavy : TravellerVersianCareers
    {
        ...
        public TravellerCareer GetNationCareer()
        {
            return new TravellerCareer(
                ...
                new List<TravellerAssignment>
                {
                    new(
                        "Small Craft Pilot",
                        "You pilot the various small craft in the Vers Empire, from shuttles and fighters, to intrasystem transports and battleships. If it lacks FTL, you fly it.",
                        new TravellerAttributeCheck(Dexterity, 8),
                        new TravellerAttributeCheck(Endurance, 7),
                    ...
                    new(
                        "Capital Stellarcraft Shipmember",
                        "You serve aboard one of the Empires Capita Stellarcraft. The massive vessels originally built around their Aldnoah Drive, now though the term refers to any ship which is capable of FTL travel.",
                    ...
                    new(
                        "Down Officer",
                        "You are a member of the Navy, but your role tends to focus more on descending to planets or stations, dealing with on ship issues like boarding parties or trade disputes, managing internal personnel, etc.",
                        new TravellerAttributeCheck(Endurance, 6),
                        new TravellerAttributeCheck(Intelligence, 10),
                        new List<TravellerSkillTableEntry>
                        {
                ...
                }, musteringOutBenefits: new List<(int Cash, TravellerCharacterCreationReward Benefit)>
                {
                    ...
                    (10000, new TravellerRewardAttribute(Social)),
                ...
                mishaps: new List<TravellerEventCharacterCreation>
                {
                    ...
                    new TravellerEventChangeCareers(
                        "During your time on watch, something goes horribly wrong, and several lives are lost. You are blamed for this, and after being court martialed you are sentenced to prison.",
                        "Versian Prisoner"),

                    new TravellerEventChangeCareers(
                        "The master of the ship you’re on decides the correct action is a ground assault; it goes… poorly. After running out of infantrymen, you’re drafted into the military.",
                        "Versian Army"),

                    new TravellerEventText(
                        "You are caught fraternizing with someone well below your rank and are kicked out for it."),

                    new TravellerEventText(
                        "You finally have enough of the dickwad who has been tormenting you shipside for years, and decided to flee into the night during your next stop at port."),
                ...
                events: new List<TravellerEventCharacterCreation>
                {
                    ...
                    new TravellerEventSkillCheck(
                        "Your ship was able to disable an enemy in an intense space battle, and you’ve been tagged to be part of a boarding party.",
                        new TravellerEventReward(
                            "You are able to capture the enemy prize, and take her to a friendly port, giving you a tidy profit.",
                            new TravellerRewardBonusBenefit()),
                        new TravellerEventInjury(
                            "You failed to capture the enemy prize, and were wounded in the process."),
                    ...
                    new TravellerEventChoice(
                        ...
                        yesEvent: new TravellerEventChoice(
                            ...
                            new TravellerEventRewardSkill(
                                "The plant stays in the ground, as you choose to instead spend several hours walking around the area, taking samples and readings. Whatever happened here, happened so long ago that it may be lost to history. You return to the ship feeling reinvigorated having had a good away mission.",
                                Science_History)),
                        noText: "Leave the planet in its place",
                        noEvent: new TravellerEventRewardSkill(
                            "You spent several hours walking around the area, taking samples and readings. Whatever happened here, happened so long ago that it may be lost to history. You return to the ship feeling reinvigorated having had a good away mission.",
                            Science_History)),

                    new TravellerEventChoice(
                        "You have a chance to cause your shipboard tormentor an ‘accident’, do you take it?",
                        new TravellerEventReward("", new List<TravellerCharacterCreationReward>
                        {
                            new TravellerRewardAttribute(Social, -1),
                            new TravellerRewardContact("Tormentor who suffered an accident",
                    ...
                    new TravellerEventMultiChoice(
                        ...
                        {
                            new TravellerEventSkillCheck(
                                "Attack the creatures! You get your men ready, putting the creatures in your sights.",
                                new TravellerEventReward(
                                    "You open fight on the creatures, attacking and slaughtering the village before they have time to raise any kind of defense.",
                                ...
                                new TravellerEventReward(
                                    "You are overrun, you underestimated what looked like primitives, but proved not to be.",
                                    new List<TravellerCharacterCreationReward>
                                    {
                                        new TravellerRewardContact(new Dictionary<string, TravellerNPCRelationship>
                                        {
                            ...
                            new TravellerEventSkillCheck(
                                "Try and talk to them: You approach the creatures, universal translator at the ready.",
                                new TravellerEventReward(
                                    "You’re eventually able to decode their language, and they come to believe you are some kind of deity. Laying the foundation for future translation efforts.",
                                    new List<TravellerCharacterCreationReward>
                                    {
                                        new TravellerRewardContact(new Dictionary<string, TravellerNPCRelationship>
                                        {
                            ...
                            new TravellerEventSkillCheck(
                                "Watch them for a bit: You spend some time watching the creatures",
                                new TravellerEventReward(
                                    "After watching them for a while, you discover that while they appear primitive on the ourside, they are actually quiet technologically adept, and would easily be able to overpower you in a fight.",
                                    new List<TravellerCharacterCreationReward>
                                    {
                                ...
                                new TravellerEventReward(
                                    "The creatures spot you watching them. You didn’t notice as their numbers seemed to drop. You didn’t notice as they came up behind you. But you did notice when they opened fire on you, killing everyone in your squad and wounding you.",
                                    new List<TravellerCharacterCreationReward>
                                    {
                                        new TravellerRewardContact(new Dictionary<string, TravellerNPCRelationship>
                                        {
                    ...
                    new TravellerEventChoice(
                        "The Crew aboard the ship begin to mutiny against the captain in the name of the Traitor Lord Hellsbeck, do you stand with your captain?",
                        new TravellerEventSkillCheck(
                            "You stand with your captain, your crew, and the rightful empress.",
                            new TravellerEventReward(
                                "You are able to hold the traitors back and regain control of the ship.",
                                new List<TravellerCharacterCreationReward>
                                {
                                    new TravellerRewardAdvancement(2),
                                    new TravellerRewardContact("Shipmate turned Traitor 1",
                                        TravellerNPCRelationship.Enemy),
                                    new TravellerRewardContact("Shipmate turned Traitor 2",
                                        TravellerNPCRelationship.Enemy)
                                }),
                            new TravellerEventReward(
                                "The traitors are able to win, however you still served with them and they are people of honour. They choose to leave you at the next planet they stop at.",
                                new List<TravellerCharacterCreationReward>
                                {
                                    new TravellerRewardJobChange("Versian Civis"),
                                    new TravellerRewardContact("Ex-Shipmate turned Pirate 1",
                        ...
                        new TravellerEventSkillCheck(
                            "You stand with those who want a better life, a place in government and to abolish the noble order.",
                            new TravellerEventReward(
                                "Your rebellion is successful, you begin a life of piracy aboard your ship. ",
                                new List<TravellerCharacterCreationReward>
                                {
                            ...
                            new TravellerEventReward("Your rebellion is put down and you are sentenced to prison.",
                                new List<TravellerCharacterCreationReward>
                                {
                                    new TravellerRewardJobChange("Versian Prisoner"),
                                    new TravellerRewardContact("Versian Traitor Shipmate 1",
                                        TravellerNPCRelationship.Rival),
                                    new TravellerRewardContact("Versian Traitor Shipmate 2",
                                        TravellerNPCRelationship.Rival)
                                }),
                            new List<TravellerSkillCheck>
                            {
                    ...
                    new TravellerEventSkillCheck(
                        "Your Lord has decided it is time for battle! While at war with a fellow peer of his, your ship comes across an enemy. The battle begins, you head to your battle station.",
                        new TravellerEventReward(
                            "Your ship is able to win the battle, it has its losses but it is victory.",
                            new List<TravellerCharacterCreationReward>
                            {
                        ...
                        new TravellerEventInjury(
                            "Your ship is damaged in the battle and looses, you retreat but suffer many losses."),
                        new List<TravellerSkillCheck>
                        {
                            new(Pilot, 8),
                            new(Engineer, 8),
                    ...
                    new TravellerEventChoice(
                        "A few days after setting off from port with a few Army Units aboard, you enter the Mess to find several of your friends brawling with the troops. Do you join the fighting, or try and stop it.",
                        yesText: "Join the fighting",
                        yesEvent: new TravellerEventSkillCheck(
                            "You hop into the fighting, and start to swing your fists about.",
                            new TravellerEventReward(
                                "You show the army who is in charge aboard this boat by giving them a good beating.",
                                new List<TravellerCharacterCreationReward>
                                {
                            ...
                            new TravellerEventReward(
                                "You are beaten and bruised but it was a good fight,even if someone did end up stopping it before you could finish it.",
                                new List<TravellerCharacterCreationReward>
                                {
                                    new TravellerRewardSkill(Melee),
                                    new TravellerRewardAttribute(Endurance, -1)
                        ...
                        noEvent: new TravellerEventReward(
                            "You work to pull you friends free from the army-boys, a similar counterpart on the other side gives a curt nod",
                            new List<TravellerCharacterCreationReward>
                            {
                                new TravellerRewardAdvancement(1),
                    ...
                    new TravellerEventSkillCheck(
                        "While traveling the stars, you discover an awesome alien megastructure. You are sent to investigate.",
                        new TravellerEventReward(
                            "Wandinger the immense hallways of the megastructure, you uncover a hidden trove of riches, making yourself a handsome bonus. The facility itself seems long dormant, its purpose forgotten to an empire who was themselves forgotten to everything but this place.",
                            new TravellerRewardBonusBenefit(2)),
                        new TravellerEventInjury(
                            "While investigating the structure, something goes wrong, you can momentarily feel the world slipping away from you, like you’re being sucked into the vast emptiness just outside your suit. You suffer a minor injury while investigating the ancient structure."),
                        new List<TravellerSkillCheck>
                        {
                            new(Pilot, 8),
                            new(VaccSuit, 8)
                    ...
                    new TravellerEventSkillCheck(
                        "During a battle, your ship is disabled and a boarding party has been dispatched to take your vessel. Try and find a way to hold them back.",
                        new TravellerEventReward(
                            "You push the enemies back, retaking your ship for Lord and Land. You are quickly marked for a promotion.",
                            new List<TravellerCharacterCreationReward>
                            {
                                new TravellerRewardAdvancement(2),
                                new TravellerRewardSkillChoice(1, new List<TravellerSkills>
                        ...
                        new TravellerEventChoice(
                            "You were unable to hold the enemy invaders back, they pillage your ship and take it as their own prize. They ask if you wish to swear allegiance to their Lord?",
                            new TravellerEventReward(
                                "You find it easy to change to your new Lord, however it does seem more difficult to get promoted, as you get used to the different customs of this court",
                                new TravellerRewardAdvancement(-2)),
                            new TravellerEventChangeCareers("The Lord tosses you into one of their prison.",
                                "Versian Prisoner")),
                        new List<TravellerSkillCheck>
                        {
                            new(GunCombat, 8),
