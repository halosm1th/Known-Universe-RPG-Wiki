...
namespace TravellerCharacter.CharacterCreator.Careers
{
    ...
    {
        public TravellerAssignment(string name, string description, TravellerAttributeCheck survival,
            TravellerAttributeCheck advancement, List<TravellerSkillTableEntry> skillList,
        ...
        public List<(string title, TravellerCharacterCreationReward TravellerCharacterCreationReward)> RanksAndBonuses
        {
            get;
            set;
        }
