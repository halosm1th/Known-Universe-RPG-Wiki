        ...
        {
            {
                ...
                new TravellerNationsCharacterInfo(
                    ...
                    {
                        new TravellerCharacterCreationItemReward(new List<TravellerItem>
                        {
                            new TravellerItem("Universalis Confederation Passport",100000,0,20),
                            new TravellerItem("TAS Membership",1000000,0,20)
                        }),
                        new TravellerCharacterCreationSkillReward(new List<TravellerSkill>
                        {
            ...
            },
            {
                ...
                new TravellerNationsCharacterInfo("Witcher",
                    ...
                    {
                        new TravellerAttribute(Psionics, 6), new TravellerAttribute(Social, 8)
                    },
                    ...
                    }, drifter:"Federation Citizen", drafts:new []{"Federation Army", "Federation Navy","Federation Scout","Lords Military"})},
            {
                ...
                new TravellerNationsCharacterInfo("Luna Knights",
                    ...
                    entryRequirements:new List<TravellerAttribute>
                    {
                        new TravellerAttribute(Dexterity,8),
                        new TravellerAttribute(Endurance,8),
                        new TravellerAttribute(Psionics,8),
                        new TravellerAttribute(Strength,8)
                    ...
                    }, drifter:"Versian Production Worker", drafts:new string[]{"Versian Army", "Versian Navy"})},
            {
                ...
                new TravellerNationsCharacterInfo("Equites Ordinis deorum",
                    ...
                    entryRequirements:new List<TravellerAttribute>
                    {
                        new TravellerAttribute(Psionics, 6),
                        new TravellerAttribute(Social, 8)
                    },
                    ...
                    }, drifter:"Deutschland Prisoner", drafts:new string[]{"Deutschland Army", "Deutschland Navy", "Deutschland Colonizer"})},
            {
                ...
                new TravellerNationsCharacterInfo("Church of Sigmar",
                    ...
                    entryRequirements:new List<TravellerAttribute>
                    {
                        new TravellerAttribute(Social,10),
                        new TravellerAttribute(Psionics,8)
                    },
