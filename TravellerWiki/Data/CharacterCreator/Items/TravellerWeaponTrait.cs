    ...
    public class TravellerWeaponTrait
    {
        ...
        public static string AnyTraitText(TravellerWeaponTraits weaponTrait) =>
            weaponTrait switch
            {
                ...
                TravellerWeaponTraits.Auto_X => "These weapons fire multiple rounds with every pull of the trigger, filling the air with a hail of fire. A weapon with the Auto trait can make" +
                ...
                TravellerWeaponTraits.Dangerous => "This weapon can be as lethal to the Traveller using it as his intended target. " +
                ...
                TravellerWeaponTraits.Fire => "This weapon sets a target on fire, causing damage every round after the initial attack. " +
                ...
                TravellerWeaponTraits.One_Use => "This weapon is designed to be used just once, completely expending its energy or ammunition " +
                                                 "in one go and then being rendered useless.",
                
                TravellerWeaponTraits.Radiation => "When a Radiation weapon is fired, anyone close to the firer, target and the line of fire " +
                ...
                TravellerWeaponTraits.Scope => "The weapon has been fitted with vision-enhancing sights, allowing it to put shots on target " +
                ...
                TravellerWeaponTraits.Smart => "This weapon has intelligent or semi-intelligent rounds that are able to guide themselves onto a " +
                ...
                TravellerWeaponTraits.Silent => "Most projectile weapons require a noisy discharge of chemical, heat or kinetic energy" +
                ...
                TravellerWeaponTraits.Stun => "These weapons are designed to deal non-lethal damage, incapacitating a living target rather than " +
                ...
                TravellerWeaponTraits.VeryBulky => "Some weapons are designed only for the strongest combatants. A Traveller using a Very " +
                ...
                TravellerWeaponTraits.VeryDangerous => "Only a madman uses a weapon with the reputation of this one. If an attack roll " +
