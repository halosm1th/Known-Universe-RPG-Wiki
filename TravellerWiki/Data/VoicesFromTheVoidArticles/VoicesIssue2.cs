    ...
    public class VoicesIssue2
    {
        public static VoicesFromTheVoidIssue AddIssue2()
        {
            return new VoicesFromTheVoidIssue(
                ...
                issueDescription: "Following the Plague Outbreak that occured in 83390 within the Western Islands Trade Federation",
                issueNumber: 2,
                articles: new List<VoicesFromTheVoidArticle>
                {
                    ...
                    new VoicesFromTheVoidArticle(
                        ...
                        articleName:"Following the money, how the Western Islands Alliance unintentionally contributed to the Red-Zone in the Oren Wastes 2 Subsector.",
                        publisher: IslandsSectorPublishers.Voices_From_The_Void,
