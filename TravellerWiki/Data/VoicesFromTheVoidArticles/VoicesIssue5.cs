    ...
    public class VoicesIssue5
    {
        public static VoicesFromTheVoidIssue AddIssue5()
        {
            return new VoicesFromTheVoidIssue(
                ...
                issueDescription: "Stars in the Void is a special issue of Voices in the Void highlighting some smaller, local pieces that may not have otherwise made the major papers.",
                issueNumber: 5,
                new List<VoicesFromTheVoidArticle>
                {
                    ...
                    new VoicesFromTheVoidArticle(
                        ...
                        articleName: "Spiritwood Senate passes vote to Condemn Essig Kritarchy; Cites piracy along major trade-ways",
                    ...
                    new VoicesFromTheVoidArticle(
                        ...
                        articleName: "New Colchis Business Board Votes to Allow Construction of Military Vessels for Outside Nation.",
                    ...
                    new VoicesFromTheVoidArticle(
                        ...
                        articleName: "Dominate Supreme Announces Funding for 5 new Sith Temples within the Dominate of the Imperial Faith; Construction begins in 3 months; expected to finished in 5;",
                    ...
                    new VoicesFromTheVoidArticle(
                        articleAuthor: "Martha Gorste",
                        articleName: "From Commoner to Countess. The story of Favonia Plautis nee Avitus, Countess of Belview.",
