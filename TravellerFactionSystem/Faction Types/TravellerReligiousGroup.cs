...
namespace TravellerFactionSystem.Faction_Types
{
    ...
    {
        public TravellerReligion(int numberOfFollowers, string factionName, int headquatersTextLocation,
            TravellerIslandsNations islandsNation, TravellerNationalities supportingNationality, string factionHeadName,
            List<int> otherOwnedLocations, TravellerDateTime foundedYear,
        ...
        {
            return
                $"The religion of {FactionName} first came to prominence in the Islands in {FoundedYear} on {HeadquatersTextLocation}. It is currently headed by {FactionHead.Name}" +
