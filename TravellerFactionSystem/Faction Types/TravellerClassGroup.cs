...
{
    public class TravellerClassGroup : TravellerFaction
    {
        public TravellerClassGroup(string factionName, int headquatersTextLocation,
        ...
        {
            var factionType = "Social Class";

            return
                $"The {factionType} named {FactionName} first came to prominence in the Islands in {FoundedYear} on {HeadquatersTextLocation}. It is currently headed by {FactionHead.Name}" +
